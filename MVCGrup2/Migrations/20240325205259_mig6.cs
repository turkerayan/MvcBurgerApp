    ...
    public partial class mig6 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraMats", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MVCGrup2User2 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraMatOrder", x => new { x.ExtraMatsId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_ExtraMatOrder_ExtraMats_ExtraMatsId",
                        column: x => x.ExtraMatsId,
                        principalTable: "ExtraMats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtraMatOrder_Orders_OrdersId",
                        column: x => x.OrdersId,
